...
struct Device_t g_deviceAudio = { _audioName, _audioDescriptorDevice, _audioDescriptorConfig };
...
struct Device_t g_deviceCdc = { _cdcName, _cdcDescriptorDevice, _cdcDescriptorConfig };
...
unsigned char _physicalDescriptorConfig[] = {
    //  Descriptor Config
	0x09, // bLength
	0x02, // bDescriptorType
	0x19, // wTotalLengthL
...
struct Device_t g_devicePhysical = { _physicalName, _physicalDescriptorDevice, _physicalDescriptorConfig };
